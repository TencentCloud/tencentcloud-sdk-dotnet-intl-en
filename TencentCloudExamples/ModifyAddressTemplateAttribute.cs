    ...
    public class ModifyAddressTemplateAttribute
    {
        public static void Run(string[] args)
        {
            try
            {
                ...
                // Instantiate the client object for the product you want to request (using VPC as an example).
                ...
                // You can check the SDK source code directly to see what properties can be set for ModifyAddressTemplateAttributeRequest.
                ...
                // Call the ModifyAddressTemplateAttribute method via the client object to initiate the request. Note that the method name corresponds to the request object.
                // The returned 'resp' is an instance of the ModifyAddressTemplateAttributeResponse class, which corresponds to the request object.
