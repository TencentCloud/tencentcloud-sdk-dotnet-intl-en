...
namespace TencentCloud.Dnspod.V20210323.Models
{
    ...
    public class DescribeRecordLineListResponse : AbstractModel
    {
        ...
        public LineInfo[] LineList{ get; set; }

        /// <summary>
        /// List of split zone groups.
        /// </summary>
        [JsonProperty("LineGroupList")]
        public LineGroupInfo[] LineGroupList{ get; set; }
