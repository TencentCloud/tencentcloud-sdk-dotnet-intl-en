...
namespace TencentCloud.Gse.V20191112.Models
{
    ...
    public class DescribeTimerScalingPoliciesResponse : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("TimerScalingPolicies")]
        public TimerScalingPolicy[] TimerScalingPolicies{ get; set; }
