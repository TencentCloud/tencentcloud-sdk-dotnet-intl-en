...
namespace TencentCloud.Mps.V20190612.Models
{
    ...
    public class AiAnalysisTaskHeadTailResult : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("Input")]
        public AiAnalysisTaskHeadTailInput Input{ get; set; }
        ...
        /// </summary>
        [JsonProperty("Output")]
        public AiAnalysisTaskHeadTailOutput Output{ get; set; }
