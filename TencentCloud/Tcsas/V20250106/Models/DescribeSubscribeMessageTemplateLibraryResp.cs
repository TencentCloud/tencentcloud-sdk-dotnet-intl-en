...
namespace TencentCloud.Tcsas.V20250106.Models
{
    ...
    public class DescribeSubscribeMessageTemplateLibraryResp : AbstractModel
    {
        ...
        public DescribeSubscribeMessageTemplateLibraryKeywordInfoResp[] KeywordList{ get; set; }
