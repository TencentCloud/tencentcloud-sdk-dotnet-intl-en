...
namespace TencentCloud.Tcsas.V20250106
{
   ...
   public class TcsasClient : AbstractClient{
       ...
       private const string sdkVersion = "SDK_NET_3.0.1301";
        ...
        /// </summary>
        /// <param name="req"><see cref="ConfigureMNGPreviewRequest"/></param>
        /// <returns><see cref="ConfigureMNGPreviewResponse"/></returns>
        public Task<ConfigureMNGPreviewResponse> ConfigureMNGPreview(ConfigureMNGPreviewRequest req)
        {
            return InternalRequestAsync<ConfigureMNGPreviewResponse>(req, "ConfigureMNGPreview");
        }
        ...
        /// <param name="req"><see cref="ConfigureMNGPreviewRequest"/></param>
        /// <returns><see cref="ConfigureMNGPreviewResponse"/></returns>
        public ConfigureMNGPreviewResponse ConfigureMNGPreviewSync(ConfigureMNGPreviewRequest req)
        {
            return InternalRequestAsync<ConfigureMNGPreviewResponse>(req, "ConfigureMNGPreview")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="CreateMNGRequest"/></param>
        /// <returns><see cref="CreateMNGResponse"/></returns>
        public Task<CreateMNGResponse> CreateMNG(CreateMNGRequest req)
        {
            return InternalRequestAsync<CreateMNGResponse>(req, "CreateMNG");
        }
        ...
        /// <param name="req"><see cref="CreateMNGRequest"/></param>
        /// <returns><see cref="CreateMNGResponse"/></returns>
        public CreateMNGResponse CreateMNGSync(CreateMNGRequest req)
        {
            return InternalRequestAsync<CreateMNGResponse>(req, "CreateMNG")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// <returns><see cref="CreateMNGApprovalResponse"/></returns>
        public Task<CreateMNGApprovalResponse> CreateMNGApproval(CreateMNGApprovalRequest req)
        {
            return InternalRequestAsync<CreateMNGApprovalResponse>(req, "CreateMNGApproval");
        }
        ...
        /// <param name="req"><see cref="CreateMNGApprovalRequest"/></param>
        /// <returns><see cref="CreateMNGApprovalResponse"/></returns>
        public CreateMNGApprovalResponse CreateMNGApprovalSync(CreateMNGApprovalRequest req)
        {
            return InternalRequestAsync<CreateMNGApprovalResponse>(req, "CreateMNGApproval")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="CreateMNGDomainACLRequest"/></param>
        /// <returns><see cref="CreateMNGDomainACLResponse"/></returns>
        public Task<CreateMNGDomainACLResponse> CreateMNGDomainACL(CreateMNGDomainACLRequest req)
        {
            return InternalRequestAsync<CreateMNGDomainACLResponse>(req, "CreateMNGDomainACL");
        }
        ...
        /// <param name="req"><see cref="CreateMNGDomainACLRequest"/></param>
        /// <returns><see cref="CreateMNGDomainACLResponse"/></returns>
        public CreateMNGDomainACLResponse CreateMNGDomainACLSync(CreateMNGDomainACLRequest req)
        {
            return InternalRequestAsync<CreateMNGDomainACLResponse>(req, "CreateMNGDomainACL")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="CreateMNGSensitiveAPIPermissionApprovalRequest"/></param>
        /// <returns><see cref="CreateMNGSensitiveAPIPermissionApprovalResponse"/></returns>
        public Task<CreateMNGSensitiveAPIPermissionApprovalResponse> CreateMNGSensitiveAPIPermissionApproval(CreateMNGSensitiveAPIPermissionApprovalRequest req)
        {
            return InternalRequestAsync<CreateMNGSensitiveAPIPermissionApprovalResponse>(req, "CreateMNGSensitiveAPIPermissionApproval");
        }
        ...
        /// <param name="req"><see cref="CreateMNGSensitiveAPIPermissionApprovalRequest"/></param>
        /// <returns><see cref="CreateMNGSensitiveAPIPermissionApprovalResponse"/></returns>
        public CreateMNGSensitiveAPIPermissionApprovalResponse CreateMNGSensitiveAPIPermissionApprovalSync(CreateMNGSensitiveAPIPermissionApprovalRequest req)
        {
            return InternalRequestAsync<CreateMNGSensitiveAPIPermissionApprovalResponse>(req, "CreateMNGSensitiveAPIPermissionApproval")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// <returns><see cref="CreateMNGVersionResponse"/></returns>
        public Task<CreateMNGVersionResponse> CreateMNGVersion(CreateMNGVersionRequest req)
        {
            return InternalRequestAsync<CreateMNGVersionResponse>(req, "CreateMNGVersion");
        }
        ...
        /// <param name="req"><see cref="CreateMNGVersionRequest"/></param>
        /// <returns><see cref="CreateMNGVersionResponse"/></returns>
        public CreateMNGVersionResponse CreateMNGVersionSync(CreateMNGVersionRequest req)
        {
            return InternalRequestAsync<CreateMNGVersionResponse>(req, "CreateMNGVersion")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="DeleteMNGRequest"/></param>
        /// <returns><see cref="DeleteMNGResponse"/></returns>
        public Task<DeleteMNGResponse> DeleteMNG(DeleteMNGRequest req)
        {
            return InternalRequestAsync<DeleteMNGResponse>(req, "DeleteMNG");
        }
        ...
        /// <param name="req"><see cref="DeleteMNGRequest"/></param>
        /// <returns><see cref="DeleteMNGResponse"/></returns>
        public DeleteMNGResponse DeleteMNGSync(DeleteMNGRequest req)
        {
            return InternalRequestAsync<DeleteMNGResponse>(req, "DeleteMNG")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        public Task<DescribeApplicationMNPListResponse> DescribeApplicationMNPList(DescribeApplicationMNPListRequest req)
        {
            return InternalRequestAsync<DescribeApplicationMNPListResponse>(req, "DescribeApplicationMNPList");
        }
        ...
        /// <param name="req"><see cref="DescribeApplicationMNPListRequest"/></param>
        /// <returns><see cref="DescribeApplicationMNPListResponse"/></returns>
        public DescribeApplicationMNPListResponse DescribeApplicationMNPListSync(DescribeApplicationMNPListRequest req)
        {
            return InternalRequestAsync<DescribeApplicationMNPListResponse>(req, "DescribeApplicationMNPList")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="DescribeMNGRequest"/></param>
        /// <returns><see cref="DescribeMNGResponse"/></returns>
        public Task<DescribeMNGResponse> DescribeMNG(DescribeMNGRequest req)
        {
            return InternalRequestAsync<DescribeMNGResponse>(req, "DescribeMNG");
        }
        ...
        /// <param name="req"><see cref="DescribeMNGRequest"/></param>
        /// <returns><see cref="DescribeMNGResponse"/></returns>
        public DescribeMNGResponse DescribeMNGSync(DescribeMNGRequest req)
        {
            return InternalRequestAsync<DescribeMNGResponse>(req, "DescribeMNG")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        public Task<DescribeMNGAllStageVersionsResponse> DescribeMNGAllStageVersions(DescribeMNGAllStageVersionsRequest req)
        {
        ...
        public Task<DescribeMNGCategoryResponse> DescribeMNGCategory(DescribeMNGCategoryRequest req)
        {
            return InternalRequestAsync<DescribeMNGCategoryResponse>(req, "DescribeMNGCategory");
        }
        ...
        /// <param name="req"><see cref="DescribeMNGCategoryRequest"/></param>
        /// <returns><see cref="DescribeMNGCategoryResponse"/></returns>
        public DescribeMNGCategoryResponse DescribeMNGCategorySync(DescribeMNGCategoryRequest req)
        {
            return InternalRequestAsync<DescribeMNGCategoryResponse>(req, "DescribeMNGCategory")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="DescribeMNGDomainACLRequest"/></param>
        /// <returns><see cref="DescribeMNGDomainACLResponse"/></returns>
        public Task<DescribeMNGDomainACLResponse> DescribeMNGDomainACL(DescribeMNGDomainACLRequest req)
        {
            return InternalRequestAsync<DescribeMNGDomainACLResponse>(req, "DescribeMNGDomainACL");
        }
        ...
        /// <param name="req"><see cref="DescribeMNGDomainACLRequest"/></param>
        /// <returns><see cref="DescribeMNGDomainACLResponse"/></returns>
        public DescribeMNGDomainACLResponse DescribeMNGDomainACLSync(DescribeMNGDomainACLRequest req)
        {
            return InternalRequestAsync<DescribeMNGDomainACLResponse>(req, "DescribeMNGDomainACL")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="DescribeMNGListRequest"/></param>
        /// <returns><see cref="DescribeMNGListResponse"/></returns>
        public Task<DescribeMNGListResponse> DescribeMNGList(DescribeMNGListRequest req)
        {
            return InternalRequestAsync<DescribeMNGListResponse>(req, "DescribeMNGList");
        }
        ...
        /// <param name="req"><see cref="DescribeMNGListRequest"/></param>
        /// <returns><see cref="DescribeMNGListResponse"/></returns>
        public DescribeMNGListResponse DescribeMNGListSync(DescribeMNGListRequest req)
        {
            return InternalRequestAsync<DescribeMNGListResponse>(req, "DescribeMNGList")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="DescribeMNGOfflinePackageURLRequest"/></param>
        /// <returns><see cref="DescribeMNGOfflinePackageURLResponse"/></returns>
        public Task<DescribeMNGOfflinePackageURLResponse> DescribeMNGOfflinePackageURL(DescribeMNGOfflinePackageURLRequest req)
        {
            return InternalRequestAsync<DescribeMNGOfflinePackageURLResponse>(req, "DescribeMNGOfflinePackageURL");
        }
        ...
        /// <param name="req"><see cref="DescribeMNGOfflinePackageURLRequest"/></param>
        /// <returns><see cref="DescribeMNGOfflinePackageURLResponse"/></returns>
        public DescribeMNGOfflinePackageURLResponse DescribeMNGOfflinePackageURLSync(DescribeMNGOfflinePackageURLRequest req)
        {
            return InternalRequestAsync<DescribeMNGOfflinePackageURLResponse>(req, "DescribeMNGOfflinePackageURL")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="DescribeMNGPreviewRequest"/></param>
        /// <returns><see cref="DescribeMNGPreviewResponse"/></returns>
        public Task<DescribeMNGPreviewResponse> DescribeMNGPreview(DescribeMNGPreviewRequest req)
        {
            return InternalRequestAsync<DescribeMNGPreviewResponse>(req, "DescribeMNGPreview");
        }
        ...
        /// <param name="req"><see cref="DescribeMNGPreviewRequest"/></param>
        /// <returns><see cref="DescribeMNGPreviewResponse"/></returns>
        public DescribeMNGPreviewResponse DescribeMNGPreviewSync(DescribeMNGPreviewRequest req)
        {
            return InternalRequestAsync<DescribeMNGPreviewResponse>(req, "DescribeMNGPreview")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        public Task<DescribeMNGReleasedVersionHistoryResponse> DescribeMNGReleasedVersionHistory(DescribeMNGReleasedVersionHistoryRequest req)
        {
            return InternalRequestAsync<DescribeMNGReleasedVersionHistoryResponse>(req, "DescribeMNGReleasedVersionHistory");
        }
        ...
        /// <param name="req"><see cref="DescribeMNGReleasedVersionHistoryRequest"/></param>
        /// <returns><see cref="DescribeMNGReleasedVersionHistoryResponse"/></returns>
        public DescribeMNGReleasedVersionHistoryResponse DescribeMNGReleasedVersionHistorySync(DescribeMNGReleasedVersionHistoryRequest req)
        {
            return InternalRequestAsync<DescribeMNGReleasedVersionHistoryResponse>(req, "DescribeMNGReleasedVersionHistory")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        public Task<DescribeMNGSensitiveAPIPermissionApprovalResponse> DescribeMNGSensitiveAPIPermissionApproval(DescribeMNGSensitiveAPIPermissionApprovalRequest req)
        {
            return InternalRequestAsync<DescribeMNGSensitiveAPIPermissionApprovalResponse>(req, "DescribeMNGSensitiveAPIPermissionApproval");
        }
        ...
        /// <param name="req"><see cref="DescribeMNGSensitiveAPIPermissionApprovalRequest"/></param>
        /// <returns><see cref="DescribeMNGSensitiveAPIPermissionApprovalResponse"/></returns>
        public DescribeMNGSensitiveAPIPermissionApprovalResponse DescribeMNGSensitiveAPIPermissionApprovalSync(DescribeMNGSensitiveAPIPermissionApprovalRequest req)
        {
            return InternalRequestAsync<DescribeMNGSensitiveAPIPermissionApprovalResponse>(req, "DescribeMNGSensitiveAPIPermissionApproval")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        public Task<DescribeMNGSensitiveAPIPermissionListResponse> DescribeMNGSensitiveAPIPermissionList(DescribeMNGSensitiveAPIPermissionListRequest req)
        {
            return InternalRequestAsync<DescribeMNGSensitiveAPIPermissionListResponse>(req, "DescribeMNGSensitiveAPIPermissionList");
        }
        ...
        /// <param name="req"><see cref="DescribeMNGSensitiveAPIPermissionListRequest"/></param>
        /// <returns><see cref="DescribeMNGSensitiveAPIPermissionListResponse"/></returns>
        public DescribeMNGSensitiveAPIPermissionListResponse DescribeMNGSensitiveAPIPermissionListSync(DescribeMNGSensitiveAPIPermissionListRequest req)
        {
            return InternalRequestAsync<DescribeMNGSensitiveAPIPermissionListResponse>(req, "DescribeMNGSensitiveAPIPermissionList")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        public Task<DescribeMNGVersionResponse> DescribeMNGVersion(DescribeMNGVersionRequest req)
        {
            return InternalRequestAsync<DescribeMNGVersionResponse>(req, "DescribeMNGVersion");
        }
        ...
        /// <param name="req"><see cref="DescribeMNGVersionRequest"/></param>
        /// <returns><see cref="DescribeMNGVersionResponse"/></returns>
        public DescribeMNGVersionResponse DescribeMNGVersionSync(DescribeMNGVersionRequest req)
        {
            return InternalRequestAsync<DescribeMNGVersionResponse>(req, "DescribeMNGVersion")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="ModifyMNGRequest"/></param>
        /// <returns><see cref="ModifyMNGResponse"/></returns>
        public Task<ModifyMNGResponse> ModifyMNG(ModifyMNGRequest req)
        {
            return InternalRequestAsync<ModifyMNGResponse>(req, "ModifyMNG");
        }
        ...
        /// <param name="req"><see cref="ModifyMNGRequest"/></param>
        /// <returns><see cref="ModifyMNGResponse"/></returns>
        public ModifyMNGResponse ModifyMNGSync(ModifyMNGRequest req)
        {
            return InternalRequestAsync<ModifyMNGResponse>(req, "ModifyMNG")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// <returns><see cref="ModifyMNGDomainResponse"/></returns>
        public Task<ModifyMNGDomainResponse> ModifyMNGDomain(ModifyMNGDomainRequest req)
        {
            return InternalRequestAsync<ModifyMNGDomainResponse>(req, "ModifyMNGDomain");
        }
        ...
        /// <param name="req"><see cref="ModifyMNGDomainRequest"/></param>
        /// <returns><see cref="ModifyMNGDomainResponse"/></returns>
        public ModifyMNGDomainResponse ModifyMNGDomainSync(ModifyMNGDomainRequest req)
        {
            return InternalRequestAsync<ModifyMNGDomainResponse>(req, "ModifyMNGDomain")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// <returns><see cref="ReleaseMNGVersionResponse"/></returns>
        public Task<ReleaseMNGVersionResponse> ReleaseMNGVersion(ReleaseMNGVersionRequest req)
        {
            return InternalRequestAsync<ReleaseMNGVersionResponse>(req, "ReleaseMNGVersion");
        }
        ...
        /// <param name="req"><see cref="ReleaseMNGVersionRequest"/></param>
        /// <returns><see cref="ReleaseMNGVersionResponse"/></returns>
        public ReleaseMNGVersionResponse ReleaseMNGVersionSync(ReleaseMNGVersionRequest req)
        {
            return InternalRequestAsync<ReleaseMNGVersionResponse>(req, "ReleaseMNGVersion")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="RemoveMNGRequest"/></param>
        /// <returns><see cref="RemoveMNGResponse"/></returns>
        public Task<RemoveMNGResponse> RemoveMNG(RemoveMNGRequest req)
        {
            return InternalRequestAsync<RemoveMNGResponse>(req, "RemoveMNG");
        }
        ...
        /// <param name="req"><see cref="RemoveMNGRequest"/></param>
        /// <returns><see cref="RemoveMNGResponse"/></returns>
        public RemoveMNGResponse RemoveMNGSync(RemoveMNGRequest req)
        {
            return InternalRequestAsync<RemoveMNGResponse>(req, "RemoveMNG")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        /// </summary>
        /// <param name="req"><see cref="RollbackMNGVersionRequest"/></param>
        /// <returns><see cref="RollbackMNGVersionResponse"/></returns>
        public Task<RollbackMNGVersionResponse> RollbackMNGVersion(RollbackMNGVersionRequest req)
        {
            return InternalRequestAsync<RollbackMNGVersionResponse>(req, "RollbackMNGVersion");
        }
        ...
        /// <param name="req"><see cref="RollbackMNGVersionRequest"/></param>
        /// <returns><see cref="RollbackMNGVersionResponse"/></returns>
        public RollbackMNGVersionResponse RollbackMNGVersionSync(RollbackMNGVersionRequest req)
        {
            return InternalRequestAsync<RollbackMNGVersionResponse>(req, "RollbackMNGVersion")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
