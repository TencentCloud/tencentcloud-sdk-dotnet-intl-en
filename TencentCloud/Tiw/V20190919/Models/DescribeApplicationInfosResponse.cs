...
namespace TencentCloud.Tiw.V20190919.Models
{
    ...
    public class DescribeApplicationInfosResponse : AbstractModel
    {
        
        /// <summary>
        /// Application list.
        /// </summary>
        [JsonProperty("ApplicationInfos")]
        public ApplicationItem[] ApplicationInfos{ get; set; }

        /// <summary>
        /// Specifies whether all applications are included. The value 0 indicates no and 1 indicates yes.
        /// </summary>
        [JsonProperty("AllOption")]
        public long? AllOption{ get; set; }
