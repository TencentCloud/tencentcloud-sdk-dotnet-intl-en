...
namespace TencentCloud.Tcr.V20190924.Models
{
    ...
    public class DescribeTagRetentionExecutionResponse : AbstractModel
    {
        
        /// <summary>
        /// List of tag retention execution records
        /// </summary>
        [JsonProperty("RetentionExecutionList")]
        public RetentionExecution[] RetentionExecutionList{ get; set; }
