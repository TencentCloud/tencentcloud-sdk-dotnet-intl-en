...
namespace TencentCloud.Cvm.V20170312.Models
{
    ...
    public class DescribeLaunchTemplateVersionsResponse : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("LaunchTemplateVersionSet")]
        public LaunchTemplateVersionInfo[] LaunchTemplateVersionSet{ get; set; }
