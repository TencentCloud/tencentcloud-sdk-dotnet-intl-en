...
namespace TencentCloud.Cdn.V20180606.Models
{
    ...
    public class DescribeReportDataResponse : AbstractModel
    {
        
        /// <summary>
        /// Domain name-level data details.
        /// </summary>
        [JsonProperty("DomainReport")]
        public ReportData[] DomainReport{ get; set; }

        /// <summary>
        /// Project-level data details
        /// </summary>
        [JsonProperty("ProjectReport")]
        public ReportData[] ProjectReport{ get; set; }
