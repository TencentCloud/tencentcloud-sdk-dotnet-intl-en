...
namespace TencentCloud.Tdmq.V20200217.Models
{
    ...
    public class DescribePulsarProInstanceDetailResponse : AbstractModel
    {
        ...
        public PulsarProClusterInfo ClusterInfo{ get; set; }

        /// <summary>
        /// Cluster network access point information
        /// Note: This field may return null, indicating that no valid values can be obtained.
        /// </summary>
        [JsonProperty("NetworkAccessPointInfos")]
        public PulsarNetworkAccessPointInfo[] NetworkAccessPointInfos{ get; set; }
        ...
        public PulsarProClusterSpecInfo ClusterSpecInfo{ get; set; }
