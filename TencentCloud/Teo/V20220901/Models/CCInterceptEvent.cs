...
namespace TencentCloud.Teo.V20220901.Models
{
    ...
    public class CCInterceptEvent : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("InterceptNum")]
        public long? InterceptNum{ get; set; }

        /// <summary>
        /// Block time in seconds.
        /// </summary>
        [JsonProperty("InterceptTime")]
        public long? InterceptTime{ get; set; }
