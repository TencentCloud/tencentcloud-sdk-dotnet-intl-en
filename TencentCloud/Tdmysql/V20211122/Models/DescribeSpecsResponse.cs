...
namespace TencentCloud.Tdmysql.V20211122.Models
{
    ...
    public class DescribeSpecsResponse : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("HybridNodeSpecs")]
        public StorageNodeSpec[] HybridNodeSpecs{ get; set; }

        /// <summary>
        /// <p>Purchasable specification list of svls nodes</p>
        /// </summary>
        [JsonProperty("ServerlessCcuSpec")]
