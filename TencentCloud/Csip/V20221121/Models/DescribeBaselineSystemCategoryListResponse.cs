...
namespace TencentCloud.Csip.V20221121.Models
{
    ...
    public class DescribeBaselineSystemCategoryListResponse : AbstractModel
    {
        
        /// <summary>
        /// <p>System parent category list, including subcategories and detection item ID lists under each parent category.</p>
        /// </summary>
        [JsonProperty("SystemCategoryList")]
        public BaselineSystemCategory[] SystemCategoryList{ get; set; }
