...
namespace TencentCloud.Csip.V20221121.Models
{
    ...
    public class DescribeAssetOverviewResponse : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("AssetOverview")]
        public AssetStatisticsInfo AssetOverview{ get; set; }

        /// <summary>
        /// Number of assets of the cloud service provider
        /// </summary>
        [JsonProperty("AssetProviderDistribute")]
        public AssetProviderDistributeInfo AssetProviderDistribute{ get; set; }

        /// <summary>
        /// Asset type and number of asset types with existing risks
        /// </summary>
        [JsonProperty("AssetTypeOverview")]
        public AssetTypeStatisticsInfo AssetTypeOverview{ get; set; }
