...
namespace TencentCloud.Car.V20220110.Models
{
    ...
    public class DescribeConcurrentSummaryResponse : AbstractModel
    {
        
        /// <summary>
        /// Total number of prepaid (monthly subscription) concurrencies.
        /// </summary>
        [JsonProperty("PrepaidConcurrentTotal")]
        public ulong? PrepaidConcurrentTotal{ get; set; }

        /// <summary>
        /// Remaining duration of an hourly package.
        /// </summary>
        [JsonProperty("HourlyRemainDuration")]
        public string HourlyRemainDuration{ get; set; }
