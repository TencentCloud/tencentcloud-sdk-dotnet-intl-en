...
namespace TencentCloud.Car.V20220110.Models
{
    ...
    public class DescribeApplicationListResponse : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("UserApplicationList")]
        public UserApplicationInfo[] UserApplicationList{ get; set; }

        /// <summary>
        /// Total number of applications.
        /// </summary>
        [JsonProperty("ApplicationTotal")]
        public long? ApplicationTotal{ get; set; }

        /// <summary>
        /// Mobile application list information.
        /// </summary>
        [JsonProperty("UserMobileApplicationList")]
        public UserMobileApplicationInfo[] UserMobileApplicationList{ get; set; }
