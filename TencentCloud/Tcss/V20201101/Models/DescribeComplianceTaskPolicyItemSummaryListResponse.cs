...
namespace TencentCloud.Tcss.V20201101.Models
{
    ...
    public class DescribeComplianceTaskPolicyItemSummaryListResponse : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("PolicyItemSummaryList")]
        public CompliancePolicyItemSummary[] PolicyItemSummaryList{ get; set; }
