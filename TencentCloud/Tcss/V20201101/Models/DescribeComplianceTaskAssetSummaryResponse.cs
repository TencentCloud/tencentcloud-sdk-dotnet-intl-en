...
namespace TencentCloud.Tcss.V20201101.Models
{
    ...
    public class DescribeComplianceTaskAssetSummaryResponse : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("AssetSummaryList")]
        public ComplianceAssetSummary[] AssetSummaryList{ get; set; }
