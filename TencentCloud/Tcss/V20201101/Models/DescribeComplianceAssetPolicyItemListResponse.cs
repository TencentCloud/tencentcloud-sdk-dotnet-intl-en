...
namespace TencentCloud.Tcss.V20201101.Models
{
    ...
    public class DescribeComplianceAssetPolicyItemListResponse : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("AssetPolicyItemList")]
        public ComplianceAssetPolicyItem[] AssetPolicyItemList{ get; set; }
