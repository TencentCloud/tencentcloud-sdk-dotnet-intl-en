...
namespace TencentCloud.Ecm.V20190719.Models
{
    ...
    public class PeakFamilyInfo : AbstractModel
    {
        ...
        public InstanceFamilyTypeConfig InstanceFamily{ get; set; }

        /// <summary>
        /// Peak information of basic data.
        /// </summary>
        [JsonProperty("PeakBaseSet")]
        public PeakBase[] PeakBaseSet{ get; set; }
