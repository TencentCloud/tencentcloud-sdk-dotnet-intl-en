...
namespace TencentCloud.Intlpartnersmgt.V20220928.Models
{
    ...
    public class DescribeCustomerOwnCostExplorerSummaryResponse : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("Detail")]
        public DimensionPeriodData[] Detail{ get; set; }

        /// <summary>
        /// <p>Classification dimension statistics</p>
        /// </summary>
        [JsonProperty("TotalDetail")]
        public CostAnalyzeDimensionData TotalDetail{ get; set; }
