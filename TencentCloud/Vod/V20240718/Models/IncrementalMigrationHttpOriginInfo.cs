...
namespace TencentCloud.Vod.V20240718.Models
{
    ...
    public class IncrementalMigrationHttpOriginInfo : AbstractModel
    {
        ...
        public IncrementalMigrationHttpEndpointInfo EndpointInfo{ get; set; }

        /// <summary>
        /// Incremental migration source file information.
        /// </summary>
        [JsonProperty("FileInfo")]
        public IncrementalMigrationOriginFileInfo FileInfo{ get; set; }
