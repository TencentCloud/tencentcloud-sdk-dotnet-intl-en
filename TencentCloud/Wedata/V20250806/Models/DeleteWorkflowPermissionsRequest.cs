...
namespace TencentCloud.Wedata.V20250806.Models
{
    ...
    public class DeleteWorkflowPermissionsRequest : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("DeletePermissionList")]
        public DeleteWorkflowPermission[] DeletePermissionList{ get; set; }
