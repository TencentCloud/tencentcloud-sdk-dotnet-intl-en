...
namespace TencentCloud.Faceid.V20180301
{
   ...
   public class FaceidClient : AbstractClient{
       ...
       private const string sdkVersion = "SDK_NET_3.0.1396";
        ...
        public Task<GetNFCResultResponse> GetNFCResult(GetNFCResultRequest req)
        {
            return InternalRequestAsync<GetNFCResultResponse>(req, "GetNFCResult");
        }
        ...
        /// <param name="req"><see cref="GetNFCResultRequest"/></param>
        /// <returns><see cref="GetNFCResultResponse"/></returns>
        public GetNFCResultResponse GetNFCResultSync(GetNFCResultRequest req)
        {
            return InternalRequestAsync<GetNFCResultResponse>(req, "GetNFCResult")
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
