...
namespace TencentCloud.Vpc.V20170312.Models
{
    ...
    public class DescribeClassicLinkInstancesResponse : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("ClassicLinkInstanceSet")]
        public ClassicLinkInstance[] ClassicLinkInstanceSet{ get; set; }
