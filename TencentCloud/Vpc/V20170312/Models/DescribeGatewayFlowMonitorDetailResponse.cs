...
namespace TencentCloud.Vpc.V20170312.Models
{
    ...
    public class DescribeGatewayFlowMonitorDetailResponse : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("GatewayFlowMonitorDetailSet")]
        public GatewayFlowMonitorDetail[] GatewayFlowMonitorDetailSet{ get; set; }
