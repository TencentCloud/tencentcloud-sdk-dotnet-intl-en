...
namespace TencentCloud.Vpc.V20170312.Models
{
    ...
    public class DescribeServiceTemplateGroupsResponse : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("ServiceTemplateGroupSet")]
        public ServiceTemplateGroup[] ServiceTemplateGroupSet{ get; set; }
